...
goog.exportSymbol('proto.aserto.directory.v2.GetObjectManyRequest', null, global);
goog.exportSymbol('proto.aserto.directory.v2.GetObjectManyResponse', null, global);
 ...
 * @constructor
 */
proto.aserto.directory.v2.GetObjectManyRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.aserto.directory.v2.GetObjectManyRequest.repeatedFields_, null);
};
goog.inherits(proto.aserto.directory.v2.GetObjectManyRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.aserto.directory.v2.GetObjectManyRequest.displayName = 'proto.aserto.directory.v2.GetObjectManyRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.aserto.directory.v2.GetObjectManyResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.aserto.directory.v2.GetObjectManyResponse.repeatedFields_, null);
};
goog.inherits(proto.aserto.directory.v2.GetObjectManyResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.aserto.directory.v2.GetObjectManyResponse.displayName = 'proto.aserto.directory.v2.GetObjectManyResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.aserto.directory.v2.GetObjectManyRequest.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.aserto.directory.v2.GetObjectManyRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.aserto.directory.v2.GetObjectManyRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.aserto.directory.v2.GetObjectManyRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.aserto.directory.v2.GetObjectManyRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    paramList: jspb.Message.toObjectList(msg.getParamList(),
    aserto_directory_v2_object_pb.ObjectParam.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.aserto.directory.v2.GetObjectManyRequest}
 */
proto.aserto.directory.v2.GetObjectManyRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.aserto.directory.v2.GetObjectManyRequest;
  return proto.aserto.directory.v2.GetObjectManyRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.aserto.directory.v2.GetObjectManyRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.aserto.directory.v2.GetObjectManyRequest}
 */
proto.aserto.directory.v2.GetObjectManyRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.aserto.directory.v2.GetObjectManyRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.aserto.directory.v2.GetObjectManyRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.aserto.directory.v2.GetObjectManyRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.aserto.directory.v2.GetObjectManyRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
...
/**
 * repeated ObjectParam param = 1;
 * @return {!Array<!proto.aserto.directory.v2.ObjectParam>}
 */
proto.aserto.directory.v2.GetObjectManyRequest.prototype.getParamList = function() {
  return /** @type{!Array<!proto.aserto.directory.v2.ObjectParam>} */ (
    jspb.Message.getRepeatedWrapperField(this, aserto_directory_v2_object_pb.ObjectParam, 1));
};


/**
 * @param {!Array<!proto.aserto.directory.v2.ObjectParam>} value
 * @return {!proto.aserto.directory.v2.GetObjectManyRequest} returns this
*/
proto.aserto.directory.v2.GetObjectManyRequest.prototype.setParamList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.aserto.directory.v2.ObjectParam=} opt_value
 * @param {number=} opt_index
 * @return {!proto.aserto.directory.v2.ObjectParam}
 */
proto.aserto.directory.v2.GetObjectManyRequest.prototype.addParam = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.aserto.directory.v2.ObjectParam, opt_index);
};
 ...
 * @return {!proto.aserto.directory.v2.GetObjectManyRequest} returns this
 */
proto.aserto.directory.v2.GetObjectManyRequest.prototype.clearParamList = function() {
 ...
 * @const
 */
proto.aserto.directory.v2.GetObjectManyResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.aserto.directory.v2.GetObjectManyResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.aserto.directory.v2.GetObjectManyResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.aserto.directory.v2.GetObjectManyResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.aserto.directory.v2.GetObjectManyResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    resultsList: jspb.Message.toObjectList(msg.getResultsList(),
    aserto_directory_v2_object_pb.Object.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.aserto.directory.v2.GetObjectManyResponse}
 */
proto.aserto.directory.v2.GetObjectManyResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.aserto.directory.v2.GetObjectManyResponse;
  return proto.aserto.directory.v2.GetObjectManyResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.aserto.directory.v2.GetObjectManyResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.aserto.directory.v2.GetObjectManyResponse}
 */
proto.aserto.directory.v2.GetObjectManyResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.aserto.directory.v2.GetObjectManyResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.aserto.directory.v2.GetObjectManyResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.aserto.directory.v2.GetObjectManyResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.aserto.directory.v2.GetObjectManyResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getResultsList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
 ...
 * @return {!Array<!proto.aserto.directory.v2.Object>}
 */
proto.aserto.directory.v2.GetObjectManyResponse.prototype.getResultsList = function() {
  return /** @type{!Array<!proto.aserto.directory.v2.Object>} */ (
    jspb.Message.getRepeatedWrapperField(this, aserto_directory_v2_object_pb.Object, 1));
};
...
/**
 * @param {!Array<!proto.aserto.directory.v2.Object>} value
 * @return {!proto.aserto.directory.v2.GetObjectManyResponse} returns this
*/
proto.aserto.directory.v2.GetObjectManyResponse.prototype.setResultsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};
 ...
 * @return {!proto.aserto.directory.v2.Object}
 */
proto.aserto.directory.v2.GetObjectManyResponse.prototype.addResults = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.aserto.directory.v2.Object, opt_index);
};
 ...
 * @return {!proto.aserto.directory.v2.GetObjectManyResponse} returns this
 */
proto.aserto.directory.v2.GetObjectManyResponse.prototype.clearResultsList = function() {
  return this.setResultsList([]);
};
