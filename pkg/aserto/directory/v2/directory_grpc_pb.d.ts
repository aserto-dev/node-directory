...
export interface IDirectoryServer extends grpc.UntypedServiceImplementation {
  ...
  listRelationTypePermissions: grpc.handleUnaryCall<aserto_directory_v2_directory_pb.ListRelationTypePermissionsRequest, aserto_directory_v2_directory_pb.ListRelationTypePermissionsResponse>;
...
export class DirectoryClient extends grpc.Client {
  ...
  listRelationTypePermissions(argument: aserto_directory_v2_directory_pb.ListRelationTypePermissionsRequest, callback: grpc.requestCallback<aserto_directory_v2_directory_pb.ListRelationTypePermissionsResponse>): grpc.ClientUnaryCall;
  listRelationTypePermissions(argument: aserto_directory_v2_directory_pb.ListRelationTypePermissionsRequest, metadataOrOptions: grpc.Metadata | grpc.CallOptions | null, callback: grpc.requestCallback<aserto_directory_v2_directory_pb.ListRelationTypePermissionsResponse>): grpc.ClientUnaryCall;
  listRelationTypePermissions(argument: aserto_directory_v2_directory_pb.ListRelationTypePermissionsRequest, metadata: grpc.Metadata | null, options: grpc.CallOptions | null, callback: grpc.requestCallback<aserto_directory_v2_directory_pb.ListRelationTypePermissionsResponse>): grpc.ClientUnaryCall;
